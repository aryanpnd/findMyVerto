...
import { getStudentExams } from "../../studentController/getStudentExamsController";

export const getFriendExams = async (req: Request, res: Response) => {
    try {
        ...
        if(friend.allowedFieldsToShow.includes("exams") === false){
        ...
        if (friend.reg_no && friend.password) {
            ...
            return getStudentExams(req, res, friendBody);
        }
