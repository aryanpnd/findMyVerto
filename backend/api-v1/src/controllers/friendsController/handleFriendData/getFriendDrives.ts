...
import { getStudentMyDrives } from "../../studentController/studentMyDrivesController";

export const getFriendDrives = async (req: Request, res: Response) => {
    try {
        ...
        if(friend.allowedFieldsToShow.includes("drives") === false){
        ...
        if (friend.reg_no && friend.password) {
            ...
            return getStudentMyDrives(req, res, friendBody);
        }
